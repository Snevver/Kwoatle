  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.form}>
        <Text style={[globalStyles.text, styles.label]}>Enter your quote</Text>
        <TextInput
        ...
        <Text style={[globalStyles.text, styles.label, {marginTop: 40}]}>Enter the author of the quote</Text>
        <TextInput
          style={[globalStyles.text, styles.authorInput, { color: '#000' }]}
